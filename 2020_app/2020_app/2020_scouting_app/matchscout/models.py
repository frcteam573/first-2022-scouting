...
class matchscout(models.Model):
	...
	positioncontrol = models.IntegerField(choices = yesno, default = 'No')
	rotationcontrol= models.IntegerField(choices = yesno, default = 'No')
	#s_hatches_sum = models.(s_hatches_1 + s_hatches_2 + s_hatches_3)


	# post-match info
	ending_climb = models.IntegerField(choices = yesno, default = 'No') 
	ending_level = models.IntegerField(choices = yesno, default = 'No')
	ending_buddy = models.IntegerField(choices = yesno, default = 'No')
