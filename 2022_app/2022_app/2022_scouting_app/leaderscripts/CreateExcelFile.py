...
# ------------------------------------------------------
    ...
    #AVG
    ws_sum.cell(row = inc+9,column = 3).value = "='"+team+"'!"+"E17" #Autos
    ...
    #MIN
    ws_sum.cell(row = inc+9,column = 10).value = "='"+team+"'!"+"E18" #Autos
    ws_sum.cell(row = inc+9,column = 11).value = "='"+team+"'!"+"F18"
    ws_sum.cell(row = inc+9,column = 12).value = "='"+team+"'!"+"G18"
    ws_sum.cell(row = inc+9,column = 13).value = "='"+team+"'!"+"H18"

    ws_sum.cell(row = inc+9,column = 14).value = "='"+team+"'!"+"I18" #Tele
    ws_sum.cell(row = inc+9,column = 15).value = "='"+team+"'!"+"J18"
    ws_sum.cell(row = inc+9,column = 16).value = "='"+team+"'!"+"K18"

    #MAX
    ws_sum.cell(row = inc+9,column = 17).value = "='"+team+"'!"+"E19" #Autos
    ws_sum.cell(row = inc+9,column = 18).value = "='"+team+"'!"+"F19"
    ws_sum.cell(row = inc+9,column = 19).value = "='"+team+"'!"+"G19"
    ws_sum.cell(row = inc+9,column = 20).value = "='"+team+"'!"+"H19"

    ws_sum.cell(row = inc+9,column = 21).value = "='"+team+"'!"+"I19" #Tele
    ws_sum.cell(row = inc+9,column = 22).value = "='"+team+"'!"+"J19"
    ws_sum.cell(row = inc+9,column = 23).value = "='"+team+"'!"+"K19"

    #Pits
    ws_sum.cell(row = inc+9,column = 24).value = "='"+team+"'!"+"B5" #Tele
    ws_sum.cell(row = inc+9,column = 25).value = "='"+team+"'!"+"B11" #Tele
    ws_sum.cell(row = inc+9,column = 26).value = "='"+team+"'!"+"B12"
